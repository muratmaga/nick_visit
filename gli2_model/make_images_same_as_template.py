...
new_template_file = "/media/share/AntsThings/nick_visit/Volumes/Scan_0012__rec-36um.nrrd"
new_labels_file = "/media/share/AntsThings/nick_visit/Labels16-corrected/Scan_0012__rec-36um.nrrd"
...
ants.image_write(oriented_new_template, "/tmp/scan0012_rigid.nii.gz")
ants.image_write(oriented_new_template_labels, "/tmp/scan0012_rigid-label.nii.gz")

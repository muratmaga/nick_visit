...
#ants.image_write(labels, "/tmp/labels.nii.gz")

#exit()

# these files are already gone through the resampling above.

template2_file = base_directory + "template2-Scan_0082.nii.gz"
labels2_file = base_directory +  "template2-labels-Scan0082.nii.gz"

template2=ants.image_read(template2_file)
labels2=ants.image_read(labels2_file)
